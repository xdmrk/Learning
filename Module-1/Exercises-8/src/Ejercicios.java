...
public class Ejercicios {
    ...
    private static void ventaCamisas(Scanner sc) {
        ...
        // ventaCamisas(sc); // devuelve al inicio de la funcion hasta que el numero sea
        // positivo y pueda pasar al siguiente if
        // } --> Recursividad, mo recomendado ya que al llamar varias veces el metodo,
        // consume mucha memoria

        do {
            System.out.print("Cuantas camisas desea comprar: ");
            camisas = sc.nextInt();
            sc.nextLine(); // Limpia buffer, terminar el Scanner, debajo de clear no muestra la siguiente
                           // impresion
